...
const createRoom = async (req, res) => {
  try {
    ...
    const { roomNumber, type, price, status, bedType, size } = req.body;
    ...
    return res
      .status(200)
      .json({ success: "Room Created Successfully", room: newRoom });
  } catch (err) {
...
const updateRoom = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ success: "Room Updated Successfully", room: updatedRoom });
  } catch (error) {
